...
https://img.shields.io/badge/network-XYRON-cyan
...
Cocok untuk ekosistem AI, DeFi, dan aplikasi enterprise.
...
· Node.js Gateway – menyediakan REST API, menyimpan blok sebagai file JSON, menjadwalkan reward.
· Rust Core – daemon yang menangani semua logika konsensus, kriptografi, dan AI. Berjalan di /tmp/xyron-core.sock.
...
· Parallel hashing menggunakan rayon → memanfaatkan multi‑core CPU.
...
· Mudah di‑upgrade ke algoritma post‑quantum (CRYSTALS‑Dilithium) tanpa mengubah interface publik.
...
· Reputasi: setiap validasi yang benar menaikkan skor, yang salah menurunkan.
...
· Maksimal 21 AI worker (sesuai batas AI Master).
